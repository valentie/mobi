...
@protocol GSOnDemandEducationCollectionViewDelegate <NSObject>
...
@interface GSOnDemandEducationCollectionView : UIView <UIAlertViewDelegate,UIActionSheetDelegate,UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, MBProgressHUDDelegate, VideoCollectionViewCellDelegate>
{
    MBProgressHUD *HUD;
...
@property (nonatomic, weak) id<GSOnDemandEducationCollectionViewDelegate> delegate;
