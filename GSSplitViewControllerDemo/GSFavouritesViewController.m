...
@interface GSFavouritesViewController ()

@end

@implementation GSFavouritesViewController
...
-(void)reloadData
{
    ...
    NSURL *aUrl = [NSURL URLWithString:[NSString stringWithFormat:@"http://%@/%@favourites",API_HOST,API_END_POINT]];
