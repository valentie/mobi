...
+ (void)initialize
{
    ...
    appearance.titleFont = [UIFont fontWithName:@"Montserrat" size:20.0];
    appearance.messageFont = [UIFont fontWithName:@"Montserrat" size:16.0];
    appearance.buttonFont = [UIFont fontWithName:@"Montserrat" size:16.0];
